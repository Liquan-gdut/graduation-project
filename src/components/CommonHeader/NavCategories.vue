<template>
  <div class="header-three">
    ...
    <div class="container">
      <div class="menu">
        <div class="cd-dropdown-wrapper">
          <a class="cd-dropdown-trigger"
             href="#0">Store Categories</a>
          <nav class="cd-dropdown">
            <a href="#0"
               class="cd-close">Close</a>
      ...
      <div class="move-text">
        <div class="marquee"><a href="offers.html"> New collections are available here...... <span>Get extra 10% off
              on everything | no extra taxes </span> <span> Try shipping pass free for 15 days with
...
export default {
  ...
  methods: {
    ...
    pageJump () {
      console.log('...')
      this.$router.push({ path: `/GoodsSearchResult` })
    }
  }
}
</script>
...
.header-three
  ...
  background url('../../assets/images/bg.png') #08bce4 no-repeat
